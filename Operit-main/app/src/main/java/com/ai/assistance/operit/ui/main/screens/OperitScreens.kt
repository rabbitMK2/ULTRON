...
sealed class Screen(
    ...
    data object Ultron : Screen(navItem = NavItem.Ultron, titleRes = R.string.nav_ultron) {
        @Composable
        override fun Content(
                navController: NavController,
                navigateTo: ScreenNavigationHandler,
            ...
            com.ai.assistance.operit.ui.features.ultron.screens.UltronScreen(
                onGoBack = onGoBack
            )
        }
    }
