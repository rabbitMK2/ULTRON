...
class MainActivity : ComponentActivity() {
                ...
                if (selectedRecord != null) {
                    ...
                    AnimatedContent(
                        ...
                        when (screen) {
                            ...
                            Screen.SpeechChat -> SpeechChatScreen(settings = settings)
                            Screen.Capabilities -> CapabilitiesScreen(settings = settings)
    ...
    private fun runAgent(instruction: String, apiKey: String, baseUrl: String, model: String, maxSteps: Int) {
        ...
        mobileAgent.value = MobileAgent(vlmClient, deviceController, this, appScanner)
